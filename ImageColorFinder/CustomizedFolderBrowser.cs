...
{
	// 폴더 선택 다이얼로그를 만들때
	// FolderBrowserDialog는 UI가 사용하기 힘들고 안이쁨
	// Microsoft.WindowsAPICodePack에 있는 CommonOpenFileDialog는 해상도에 따라 창 위치가 변경되는 버그 아닌 버그가 있어
	// 사용하기 꺼려짐
	// 그래서 파일선택 다이얼로그 UI를 가진 폴더 선택 다이얼로그를 커스터마이즈해서 만듬
	// 출처 : https://stackoverflow.com/questions/11624298/how-do-i-use-openfiledialog-to-select-a-folder
	public class CustomizedFolderBrowser
	{
